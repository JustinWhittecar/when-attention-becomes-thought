...
The section readers came for. Treat the Chen et al. commentary as one input among several rather than the load-bearing argument. Give the skeptics their best day. Then state where I come down, honestly.

## Reading list

1. Turing (1950), "Computing Machinery and Intelligence."
2. Chen, Belkin, Bergen & Danks (2026), "Does AI already have human-level intelligence?" *Nature* 650, 36-40.
3. Bubeck et al. (2023), "Sparks of Artificial General Intelligence."
...
6. Chollet (2024/2025), ARC Prize report, latest edition.
7. Mitchell (2021), "Why AI Is Harder Than We Think." Names four fallacies in optimistic AI predictions. Useful for teaching the reader what to listen for when someone says a system is close to AGI.
8. LeCun (2022), "A Path Towards Autonomous Machine Intelligence."
...
New large-scale Turing-style studies. Updates to ARC-AGI and its successors. Any formal definition of AGI that gains traction in the literature. Policy milestones that anchor the AGI question in governance (EU AI Act revisions, UK AISI reports, US executive orders).
